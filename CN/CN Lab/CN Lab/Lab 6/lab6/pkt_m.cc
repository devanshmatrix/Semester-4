...
int Pkt::getMid() const
{
    return this->Mid;
}

void Pkt::setMid(int Mid)
{
    this->Mid = Mid;
}

int Pkt::getType() const
{
    return this->type;
}

void Pkt::setType(int type)
{
    this->type = type;
}
...
std::string PktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return enum2string(pp->getType(), "Type");
...
bool PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setType((Type)string2enum(value, "Type")); return true;
