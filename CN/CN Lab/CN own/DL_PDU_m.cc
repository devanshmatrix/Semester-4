...
double DL_PDU::getDestination() const
{
    return this->destination;
}

void DL_PDU::setDestination(double destination)
{
    this->destination = destination;
}

double DL_PDU::getSource() const
{
    return this->source;
}

void DL_PDU::setSource(double source)
{
    this->source = source;
}
...
std::string DL_PDUDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return double2string(pp->getDestination());
        case 3: return double2string(pp->getSource());
        default: return "";
    }
}
...
bool DL_PDUDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setDestination(string2double(value)); return true;
        case 3: pp->setSource(string2double(value)); return true;
